...
const FunData = ({ items }: InfoProps) => {
    ...
    return(
        ...
        <div className="home__data">
            ...
            <h3 className="home__subtitle">Fun Dad</h3>
            <p className="home__description">{fun}</p>
            <a href="mailto: lhidalgoarrieta@gmail.com" className=" data__contact button button--flex">
                Say Hello!
                <svg
